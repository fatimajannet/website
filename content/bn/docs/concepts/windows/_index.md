...
কুবার্নেটিস লিনাক্স বা মাইক্রোসফট উইন্ডোজ চালানো ওয়ার্কার নোড {{< glossary_tooltip text="নোড" term_id="node" >}} সমর্থন করে।

{{% thirdparty-content single="true" %}}

CNCF এবং এর মূল প্রতিষ্ঠান লিনাক্স ফাউন্ডেশন (Linux Foundation) নিরপেক্ষভাবে সামঞ্জস্যতা নিশ্চিত করে। আপনি চাইলে আপনার [উইন্ডোজ সার্ভার](https://www.microsoft.com/en-us/windows-server) কে কুবার্নেটিস ক্লাস্টারের ওয়ার্কার নোড হিসেবে যুক্ত করতে পারেন।
